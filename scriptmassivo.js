...
function gerarFrase4() {
    ...
    devido a uma manutenção na região que está afetando outros clientes. Esta manutenção tem data prevista de conclusão até ${dataReparo}`;
...
function calculoProrata() {
    ...
    // Criando a frase
    let frase5 = `Informamos que devido ao período de ${diassemserviço} dias, em que o consumidor já teve os serviços apresentando inoperância geramos crédito no valor de R$ ${calculo.toFixed(2).replace('.', ',') } `;
